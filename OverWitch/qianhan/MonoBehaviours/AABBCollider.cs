...
namespace InfiniteMemories.OverWitch.qianhan.MonoBehaviours
{
    public class AABBCollider : Collider
    {
        ...
        public AABBCollider(string name, string description, bool active, bool remove, Entity entity) : base(name, description, active, remove, entity)
        {
